...
**IMPORTANT:** Never hardcode API keys in `config.json`!
...
**Why?**
- ✅ API keys are never committed to git (they're in .gitignore)
- ✅ Different credentials per environment (dev/testnet/production)
